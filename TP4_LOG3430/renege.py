...
class RENEGE:
    ...
    def process_email(self, log_way_probs, log_way_merged_probs, stemming):
        '''
...
def calculate_trust_level(self, user_id):
    ...
    date_of_last_seen_message_unix = self.crud.convert_to_unix(
        self.crud.get_user_data(user_id, "Date_of_last_seen_message"))
    date_of_first_seen_message_unix = self.crud.convert_to_unix(
        self.crud.get_user_data(user_id, "Date_of_first_seen_message"))
